...
comment: A comprehensive guide to integrating AI in Technical and Vocational Education and Training (TVET) based on 2024-2025 research.
...
<svg width="800" height="950" viewBox="0 0 800 950" xmlns="http://www.w3.org/2000/svg">
  <style>
    /* General styles for text and shapes */
    .title { font: bold 28px 'Inter', sans-serif; fill: #2c3e50; } /* Dark blue-grey */
    .subtitle { font: 20px 'Inter', sans-serif; fill: #34495e; } /* Slightly lighter dark blue-grey */
    .heading { font: bold 22px 'Inter', sans-serif; fill: #2980b9; } /* Blue */
    .text { font: 16px 'Inter', sans-serif; fill: #34495e; } /* Dark blue-grey */
    .highlight-text { font: bold 16px 'Inter', sans-serif; fill: #e74c3c; } /* Red */
    .time-label { font: 14px 'Inter', sans-serif; fill: #fff; text-anchor: middle; }

    /* Styles for the time bars */
    .time-bar-bg { fill: #ecf0f1; stroke: #bdc3c7; stroke-width: 1; rx: 5; ry: 5; } /* Light grey background */
    .time-bar-fill-act1 { fill: #2ecc71; rx: 5; ry: 5; } /* Green */
    .time-bar-fill-act2 { fill: #f1c40f; rx: 5; ry: 5; } /* Yellow */
    .time-bar-fill-act3 { fill: #9b59b6; rx: 5; ry: 5; } /* Purple */

    /* Icon styles */
    .icon { fill: #7f8c8d; } /* Grey */
  </style>

  <!-- Act 1: Problem / Promise (15 minutes) -->
  <g id="act1-group" transform="translate(50, 50)">
    <rect x="0" y="0" width="700" height="250" class="time-bar-bg"/>
    <text x="20" y="35" class="heading">Act 1: Problem / Promise</text>
    <text x="20" y="65" class="subtitle">(15 minutes)</text>

    <!-- Time Bar for Act 1 (15 minutes) - Scale: 1 minute = 4 units width -->
    <rect x="20" y="80" width="60" height="20" class="time-bar-fill-act1"/>
    <text x="50" y="95" class="time-label">15 min</text>

    <text x="40" y="130" class="text">- Opening hook with surprising statistic: <tspan class="highlight-text">"80% time savings in content creation"</tspan></text>
    <text x="40" y="160" class="text">- Problem statement: Current TVET content creation challenges</text>
    <text x="40" y="190" class="text">- Promise: Live demonstration of AI transforming lesson planning</text>
    <text x="40" y="220" class="text">- <tspan class="highlight-text">Reset Activity:</tspan> 2-minute audience poll on current AI usage</text>

    <!-- Simple clock icon for poll -->
    <circle cx="30" cy="215" r="5" class="icon"/>
    <line x1="30" y1="215" x2="30" y2="210" stroke="#7f8c8d" stroke-width="1"/>
    <line x1="30" y1="215" x2="35" y2="215" stroke="#7f8c8d" stroke-width="1"/>
  </g>

  <!-- Act 2: Live AI Demonstration (25 minutes) -->
  <g id="act2-group" transform="translate(50, 320)">
    <rect x="0" y="0" width="700" height="300" class="time-bar-bg"/>
    <text x="20" y="35" class="heading">Act 2: Live AI Demonstration</text>
    <text x="20" y="65" class="subtitle">(25 minutes)</text>

    <!-- Time Bar for Act 2 (25 minutes) -->
  ...
  <!-- Removed Navigation Button and JavaScript -->
