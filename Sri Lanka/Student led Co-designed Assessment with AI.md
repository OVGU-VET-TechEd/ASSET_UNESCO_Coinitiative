...
<svg xmlns="http://www.w3.org/2000/svg" width="800" height="450" viewBox="0 0 800 450">
  ...
  <!-- Title -->
  <text x="400" y="190" font-family="Segoe UI, Arial, sans-serif" font-size="26" font-weight="bold" text-anchor="middle" fill="#0D47A1">
    What if AI Co-Designed Assessments with Students?
  </text>

  <!-- Subtitle -->
  <text x="400" y="250" font-family="Segoe UI, Arial, sans-serif" font-size="20" text-anchor="middle" fill="#1A237E">
    Shifting from teacher-driven to collaborative intelligence in TVET
  </text>
</svg>
...
<div style="background: linear-gradient(135deg, #0D47A1, #1976D2); color: #E3F2FD; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; padding: 2em; border-radius: 16px; box-shadow: 0 6px 18px rgba(0,0,0,0.3); max-width: 800px; margin: 2em auto; line-height: 1.6;">

<h2 style="margin-top: 0; color: #FFFFFF;">📊 Co-agency in Action for TVET Learners in Data Analysis</h2>

<blockquote style="font-style: italic; color: #BBDEFB; border-left: 4px solid #90CAF9; padding-left: 1em;">
📌 <strong>UNESCO (2023) Guidance:</strong><br><br>
...
<div style="background: linear-gradient(to right, #E0F7FA, #B2EBF2); color: #004D66; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; padding: 2em; border-radius: 16px; box-shadow: 0 6px 16px rgba(0,0,0,0.2); max-width: 800px; margin: 2em auto; line-height: 1.8;">

<blockquote style="font-style: italic; border-left: 4px solid #00ACC1; padding-left: 1em; margin: 0 0 1.5em;">
Amina is a final-year TVET student in Data Analysis for Business Intelligence.
</blockquote>

<p><strong>Her teacher offers a challenge:</strong></p>

<div style="background-color: #ffffff; border-left: 5px solid #00BCD4; padding: 1em; border-radius: 10px; box-shadow: inset 0 0 5px rgba(0,0,0,0.05);">
...
<div style="background: linear-gradient(to right, #E1F5FE, #B3E5FC); color: #003B5C; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; padding: 2em; border-radius: 16px; box-shadow: 0 6px 18px rgba(0,0,0,0.2); max-width: 800px; margin: 2em auto; line-height: 1.8;">

<h3 style="margin-top: 0;">📘 Amina is shown 3 key learning outcomes:</h3>

<ul style="margin-left: 1em;">
  <li>Analyze real-world datasets</li>
  <li>Interpret statistical results</li>
  <li>Present findings visually</li>
</ul>

<div style="background-color: #ffffff; border-left: 5px solid #03A9F4; padding: 1em; margin: 1.5em 0; border-radius: 8px;">
  <strong>Amina's Prompt to Claude:</strong><br />
  "Explain these outcomes with examples from the retail sector."
</div>

<p><strong>Claude</strong> helps her understand, not just memorize.</p>
...
<p><strong>Using ChatGPT, Amina explores project possibilities:</strong></p>

<p style="font-weight: bold; margin-top: 1em;">ChatGPT's Ideas:</p>
<ul style="margin-left: 1em; padding-left: 1em;">
  <li>Analyze seasonal sales trends</li>
  <li>Text analysis on customer feedback ⭐</li>
  <li>Logistics dashboard design</li>
</ul>

<p style="margin-top: 1.5em;"><strong>Amina chooses:</strong> Option 2 — <em>Sentiment Analysis</em></p>
...
<div style="background: linear-gradient(to right, #0D1F4F, #1A2D75); color: #CCE5FF; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; padding: 2em; border-radius: 16px; box-shadow: 0 6px 18px rgba(0,0,0,0.3); max-width: 800px; margin: 2em auto; line-height: 1.8;">

<p><strong>Amina collaborates with Claude to design her assessment criteria:</strong></p>

<div style="background-color: rgba(255,255,255,0.05); border-left: 5px solid #4FC3F7; padding: 1em; border-radius: 10px; margin: 1em 0;">
  <strong>Amina's Prompt to Claude:</strong><br />
  "Create a rubric for a text analysis project with report and dashboard."
</div>

<p><strong>Claude's Suggested Criteria:</strong></p>
<ul style="margin-left: 1em; padding-left: 1em;">
  <li>Data cleaning & preparation</li>
  <li>Analytical depth</li>
  <li>Insight clarity</li>
  <li>Visual presentation quality</li>
</ul>

<p>Her teacher helps finalize the rubric.</p>
...
| Goal           | Prompt                                | Tool    |
|----------------|---------------------------------------|---------|
| Clean data     | "How do I fix missing values in CSV?" | ChatGPT |
| Simplify text  | "Rephrase correlation explanation."   | Claude  |
| Create visuals | "How to present sentiment data?"      | ChatGPT |
| Write summary  | "Summarize findings in 3 paragraphs." | Claude  |
...
<div style="background: linear-gradient(to right, #87CEEB, #B3E5FC); color: #003366; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; padding: 2em; border-radius: 16px; box-shadow: 0 6px 18px rgba(0,0,0,0.2); max-width: 800px; margin: 2em auto; line-height: 1.7;">

<p><strong>Before submission, Amina seeks AI assistance for improvement:</strong></p>

<div style="background-color: rgba(255,255,255,0.6); border-left: 5px solid #0288D1; padding: 1em; border-radius: 10px; margin: 1em 0; color: #014f86;">
...
<p><strong>Her Reflection Areas:</strong></p>
<ul style="margin-left: 1.2em; padding-left: 1em;">
  <li>Surprises in the data</li>
  <li>How her analysis evolved</li>
  <li>What she'd do differently</li>
</ul>
...
<div style="background: linear-gradient(135deg, #0D47A1, #42A5F5); color: white; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; padding: 2em; border-radius: 16px; box-shadow: 0 6px 20px rgba(13, 71, 161, 0.7); max-width: 850px; margin: 2em auto; line-height: 1.7;">

<h3 style="margin-top: 0; color: white; font-weight: 800; font-size: 1.8em; text-shadow: 1px 1px 2px rgba(0,0,0,0.4);">
  Using Bloom's Taxonomy × UNESCO AI Competency Framework
</h3>

<p>All of Amina's prompts were analyzed for:</p>
<ul>
  <li>Bloom's Taxonomy (Cognitive levels)</li>
  <li>UNESCO AI competency Framework (progression levels)</li>
  <li>Educational purpose</li>
</ul>

<p><strong>Progression Levels:</strong></p>
<ul>
  <li>Level 1: Understand - Basic comprehension and awareness</li>
  <li>Level 2: Apply - Practical application and implementation</li>
  <li>Level 3: Create - Innovation and original development</li>
</ul>
...
<div style="background: linear-gradient(135deg, #0D47A1, #1976D2); color: #CCE5FF; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; padding: 2em; border-radius: 16px; box-shadow: 0 6px 20px rgba(13, 71, 161, 0.7); max-width: 800px; margin: 2em auto; line-height: 1.7;">

<h3 style="margin-top: 0; font-weight: 700; font-size: 1.6em;">Core Principles:</h3>

<ul style="margin-left: 1.2em;">
  <li>AI can empower learners, not replace them</li>
  <li>Students become assessment-literate through co-design</li>
  <li>ChatGPT and Claude serve as assessment coaches</li>
  <li>Promotes real-world, reflective learning</li>
</ul>

<blockquote style="margin-top: 1.5em; font-style: italic; color: #B3D1FF; border-left: 4px solid #99C2FF; padding-left: 1em;">
...
https://unesdoc.unesco.org/ark:/48223/pf0000386097
...
#     END
<div style="background: linear-gradient(135deg, #1E3A8A, #3B82F6); color: #E0E7FF; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; padding: 3em 2em; border-radius: 20px; box-shadow: 0 8px 24px rgba(30, 58, 138, 0.7); max-width: 800px; margin: 3em auto; text-align: center;">

<h1 style="margin-bottom: 0.5em; font-weight: 700; font-size: 3em;">Thank You!</h1>

<p style="font-size: 1.5em; margin-bottom: 2em;">For your participation and curiosity.</p>

<blockquote style="font-style: italic; font-size: 1.25em; color: #C7D2FE; max-width: 700px; margin: 0 auto; border-left: 5px solid #93C5FD; padding-left: 1em;">
“AI is best when it amplifies human creativity and judgment.”
</blockquote>
