...
## <span class="main-title">Workshop Structure: Discover → Create → Share</span>
...
---
## <span class="main-title">🌍 UNESCO AI Competency Framework Context</span>
...
---
## <span class="main-title">🏭 DISCOVER: AI in Key TVET Sectors</span>
>Let's explore how AI is transforming major industries. Each sector presents unique opportunities for TVET integration.
...
## <span class="main-title">Agriculture 🌾</span>
...
### One of many:
 [Leonardo.ai](https://leonardo.ai/ai-architecture-generator/)
...
---
## <span class="main-title">💬 Discussion Prompt</span>
...
- 🌾 **e.g. Agriculture Educators**: How do you teach modern farming techniques?  
- 👕 **e.g. Apparel Instructors**: What technology do you use for design or production?  
- 🏗️ **e.g.Construction Teachers**: How do you incorporate safety technology?  
- 💻 **e.g. IT/Logistics Instructors**: What emerging technologies do you cover?
...
---
## <span class="main-title">🛠️ DISCOVER: Administrative AI Tools</span>
...
### Using AI for Lesson Planning:
 ...
 Use AI to diversify your lesson planning. We’ll use ChatGPT, Perplexity.ai and Claude.ai to draft an idea and outline the firest material with Open Educational Resources.
...
---
## <span class="main-title">👥 Team Formation & Task Assignment</span>
...
**🌾 e.g. Team Agriculture**: Create an interactive module on precision farming

**👕 e.g. Team Apparel**: Design a quality control training program  

**🏗️ e.g. Team Construction**: Build a safety assessment quiz

**💻 e.g. Team Logistics/IT**: Develop a route optimization exercise
...
1. **Select a variety of AI tools** of your choosing
...
Based on (variable) weather forecast, when should you water tomato plants?
...
---
## <span class="main-title">Use external tools with AI support</span>
...
Your teams have 40 minutes to create your interactive learning modules. Use the tools and templates provided. Remember to focus on practical applications relevant to Sri Lankan industries.
...
- **Minutes 6-34**: Content creation and testing
- **Minutes 35-405**: Final review and presentation prep
</div>
...
## <span class="main-title">🎤 SHARE: Team Presentations</span>
...
---
## <span class="main-title">🤔 REFLECT: Group Discussion & Learning</span>
...
---
## <span class="main-title">💡 Key Takeaways & Action Steps</span>
...
## <span class="main-title">🎯 Core Insights</span>
...
---
## <span class="main-title">📝 Immediate Action Steps</span>
...
## <span class="main-title">🔗 Resource Toolkit</span>
...
## <span class="main-title">👥 Form AI Learning Communities</span>
...
---
## <span class="main-title">🎯 Workshop Success Metrics</span>
<div style="
  background: linear-gradient(to right, #87CEEB, #E0F7FA);
  border-radius: 20px;
  padding: 2em;
